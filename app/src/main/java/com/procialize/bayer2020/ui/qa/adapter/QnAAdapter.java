...
import static com.procialize.bayer2020.Utility.SharedPreferencesConstant.PROFILE_PIC_MEDIA_PATH;
import static com.procialize.bayer2020.ui.newsfeed.view.NewsFeedFragment.cl_main;

public class QnAAdapter extends RecyclerView.Adapter<QnAAdapter.NewsViewHolder> {

    Context context;
    ArrayList<Newsfeed_detail> feed_detail;
    QnAAdapter.FeedAdapterListner listener;
    String mediaPath = "";
    ...
    public QnAAdapter(Context context,/* ArrayList<Newsfeed_detail> feed_detail,*/ QnAAdapter.FeedAdapterListner listener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final QnAAdapter.NewsViewHolder holder, final int position) {
...
//                                    substring = substring.replace("^", "");
    ...
    public void setDynamicColor(@NonNull final QnAAdapter.NewsViewHolder holder) {
