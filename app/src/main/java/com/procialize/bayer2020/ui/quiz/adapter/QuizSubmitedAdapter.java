...
public class QuizSubmitedAdapter extends RecyclerView.Adapter<QuizSubmitedAdapter.ViewHolder>{
    ...
    public QuizSubmitedAdapter(Activity activity, List<QuizQuestion> quizList) {
