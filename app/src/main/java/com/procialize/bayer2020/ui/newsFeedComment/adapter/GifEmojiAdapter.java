...
public class GifEmojiAdapter extends RecyclerView.Adapter<GifEmojiAdapter.MyViewHolder> {
    ...
    public List<GifResult> resultsList;
    private Context context;
    private GifEmojiAdapterListner listener;

    public GifEmojiAdapter(Context context, List<GifResult> commentLists, GifEmojiAdapterListner listener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        GifResult result = resultsList.get(position);
...
//
    ...
    public interface GifEmojiAdapterListner {
        void onGifSelected(GifResult result);
