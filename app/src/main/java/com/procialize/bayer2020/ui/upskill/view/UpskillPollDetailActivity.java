...
public class UpskillPollDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String eventLogo = SharedPreference.getPref(UpskillPollDetailActivity.this, EVENT_LOGO);
        String eventListMediaPath = SharedPreference.getPref(UpskillPollDetailActivity.this, EVENT_LIST_MEDIA_PATH);
        Glide.with(UpskillPollDetailActivity.this)
        ...
        if (optionLists.size() != 0) {
            ...
            Toast.makeText(UpskillPollDetailActivity.this, "Select Option", Toast.LENGTH_SHORT).show();
        }
    ...
    public void showResponse(Response<FetchLivePoll> response) {
        ...
        if (response.body().getHeader().get(0).getType().equalsIgnoreCase("Success")) {
            ...
            RefreashToken refreashToken = new RefreashToken(UpskillPollDetailActivity.this);
            ...
            Toast.makeText(UpskillPollDetailActivity.this,
