package com.procialize.eventapp.ui.SpotQuiz.adapter;
...
import com.procialize.eventapp.ui.quiz.adapter.AnswerAdapter;
...
public class SpotQuizSubmittedAdapter extends RecyclerView.Adapter<SpotQuizSubmittedAdapter.ViewHolder>{
    ...
    public SpotQuizSubmittedAdapter(Activity activity, List<QuizQuestion> quizList) {
    ...
    @Override
    public SpotQuizSubmittedAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.quiz_row_list, parent, false);

        SpotQuizSubmittedAdapter.ViewHolder viewHolder = new SpotQuizSubmittedAdapter.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(SpotQuizSubmittedAdapter.ViewHolder holder, final int position) {
