...
import com.procialize.eventapp.ui.quiz.view.QuizSubmittedActivity;
...
public class AnswerAdapter extends RecyclerView.Adapter<AnswerAdapter.ViewHolder>{
    ...
    public AnswerAdapter(Context context, List<QuizOption> travelList, String correctAns, String SelectedAns) {
