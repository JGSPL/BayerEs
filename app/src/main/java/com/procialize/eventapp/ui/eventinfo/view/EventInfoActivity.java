...
public class EventInfoActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ConnectionDetector.getInstance(this).isConnectingToInternet()) {
            ...
            eventInfoViewModel.getEventInfo().observe(this, new Observer<EventInfo>() {
                @Override
                    ...
                    if (like != null) {
                       ...
                       /* Gson gson = new Gson();
                        ...
                        if(eventInfos.size()>0) {
                           ...
                           String strEvent_location = eventInfos.get(0).getEvent_location();
                           String strEvent_city = eventInfos.get(0).getEvent_city();
                           String strEvent_latitude = eventInfos.get(0).getEvent_latitude();
                           String strEvent_longitude = eventInfos.get(0).getEvent_longitude();
                           ...
                           String strEackground_image = eventInfos.get(0).getBackground_image();
                            ...
                            tv_date.setText(strEvent_start_date+" "+strEvent_end_date);
                            ...
                            Glide.with(EventInfoActivity.this)
                                    .load(mediaPath1+strEvent_image).circleCrop()
